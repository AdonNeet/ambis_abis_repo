...
def gmbr_tnbng():
        ...
        teks1 = Label(root,text=f'Jari - Jari: {d.tb.jari}', font=('Arial',20,'bold'))
        ...
        jawaban = Entry(root, width= 20,borderwidth=3,font=('Arial',18), textvariable=ans)
        jawaban.place(x=350,y=330)
        but_aswer = Button(root, text='Check', font=('Arial',14,'bold'),padx=20,command=d.tb.check)
...
def gmbr_kubus():
        ...
        jawaban = Entry(root, width= 40,borderwidth=3,font=('Arial',18), textvariable=ans)
        jawaban.place(x=60,y=400)

        but_aswer = Button(root, text='Check', font=('Arial',14,'bold'),padx=20,command=d.k.check)
...
def gmbr_balok():
        ...
        teks1 = Label(root,text=f'Panjang : {d.b.panjang}', font=('Arial',20,'bold'))
        teks1.place(x=500,y=80)
        teks2 = Label(root,text=f'Lebar: {d.b.lebar}', font=('Arial',20,'bold'))
        teks2.place(x=500,y=130)
        ...
        but_aswer = Button(root, text='Check', font=('Arial',14,'bold'),padx=20,command=d.b.check)
